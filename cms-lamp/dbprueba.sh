...
then
    ...
    touch > /home/$USER/acccesowordpress.txt
    echo "accceso: localhost wordpress
    nombre de la base de datos: wordpress
    usuario db: wordpress
    contraseña db: usrwordpress123 " > /home/$USER/acccesowordpress.txt
    echo "Se a creado un fichero en /home/$USER/acccesowordpress.txt con la inforación de acceso a wordpress"
